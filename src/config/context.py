...
class Context:
    def __init__(self, cfg: dict):
        ...
        # Paths
        self.path_gcp_base     = paths.get('GCP_BASE')
        self.path_logs         = paths.get('LOGS')
        self.path_output       = paths.get('OUTPUT')
        self.path_datasets     = paths.get('DATASETS')
        self.path_training_db  = paths.get('TRAINING_DB')

        self.output = self.path_gcp_base + self.path_output

        # Files
        #    datasets/
        self.file_dataset_01_raw = files.get('DATASET_01_RAW')
        self.file_dataset_02_raw = files.get('DATASET_02_RAW')
        self.file_dataset_03_raw = files.get('DATASET_03_RAW')

        self.file_dataset_01     = files.get('DATASET_01')
        self.file_database       = files.get('DATABASE')
        #    output/
